...
<form class = "form" action="sdupdate" method ="post">
    <div class="row1">
              <div class="col-50">
                <label>Doctor ID</label>
                <select id="id" name="id" <%=Doctor_id %>>
              ...
              <div class="col-50">
                ...
                <select id="fname" name="fname" <%=Doctor_name%>>
			    <option value="any">Any</option>
              ...
              <div class="col-200">
              	...
              	<select id="specialist" name="specialist" <%=specialization %>>
			    <option value="any">Any</option>
              ...
              <div>
              	...
              	<select id="hospital" name="hospital" <%=hospital %>>
			    <option value="any">Any</option>
              ...
              <div>
              	<label>Date</label>
              	<input type="date" id="date" name="date" placeholder="Any" <%=date %>></br></br>
              </div>     
            </div>
    <hr>
