  ...
  <hr/>
      <div class="form">
        <div class="contact-info">
          ...
          <p class="text"><i><b>Get in touch with our team and leav*e the online booking frustrations behind....</p></i></b>
      ...
      <a href="https://www.whatsapp.com/blossom/"><img id="img1" src="images/whap.jfif" width ="20px"></a> 
        ...
        <div class="contact-form">
          ...
          <form action="update" method="post" >
            ...
            <div class="input-container">
              <input type="email" name="email" value="<%= Email %>" class="input" />
              <span>Email</span>
            </div>
            <div class="input-container">
              <input type="tel" name="mobile" value="<%= Phone %>" class="input" />
              <span>Phone</span>
            </div>
`            <div class="input-container textarea">
              <textarea name="message" value="<%= Message %>" class="input"></textarea>
              <span>Message</span>
            </div>
         <div class="button">
